...
//como um array pode guardar diferentes valores incluse outros arrays
...
//manipualando um array 

//forEach - realiza uma função para cada item do array 
//array.forEach(functio(item, index){console.log(item, index);})
...
//unshif - remove o primeiro item do array 
//array.shift();
//conosle.log(array);
...
//indexOf -retorna o inicio de um item do array
...
//let object = { string: 'string', munber: 1, boolean; true, array: ['array'], objectInterno: { objetoInterno: 'objeto Interno'} };

/* //como acessar  propriedade de objetos
//usando ponto "."
...
let number =object.munber;
let boolean =object.boolean; */ 


//desstruturando usando chaves
//let{ string, number, boolean} = object;
//conosole.log(string, number, boolean);